...
export default function MultiStepLoader({
  ...
  return (
    <div className={`flex w-full items-center justify-center p-4 ${className}`}>
      <div className="w-full max-w-xl rounded-3xl border border-zinc-200 bg-white/90 p-8 shadow-[0_24px_80px_rgba(15,23,42,0.10)] backdrop-blur dark:border-zinc-800 dark:bg-zinc-950/85">
        <div className="mb-8">
          <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-rose-200 bg-rose-50 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-rose-600 dark:border-rose-900/80 dark:bg-rose-950/40 dark:text-rose-300">
        ...
        <div className="mb-8">
          <div className="mb-2 flex items-center justify-between text-xs font-medium uppercase tracking-[0.16em] text-zinc-500 dark:text-zinc-400">
            <span>
