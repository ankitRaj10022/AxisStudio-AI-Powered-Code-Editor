            ...
            <div
              ...
              <div className="relative z-10 flex items-center justify-between w-full gap-2">
                <div className="flex items-center gap-6 justify-center">
                  ...
                  >
                    <Image src={"/coding-program-website-computer-technology-svgrepo-com%20(1).svg"} alt="Logo" height={50} width={50}
                    />

                    <span className="hidden sm:block font-extrabold text-lg text-orange-400">
                      CodeEditor_
                    </span>
                  </Link>
                  ...
                  <div className="hidden sm:flex items-center gap-4">
                    ...
                    <Link href="https://codesnippetui.pro/templates utm_source=codesnippetui.com&utm_medium=header" target="_blank" className="text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors flex items-center gap-2">
                      API
                ...
                <div className="flex sm:hidden items-center gap-4">
                  <Link href="/docs/components/action-search-bar" className="text-sm text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors">
                    Docs
                  </Link>
