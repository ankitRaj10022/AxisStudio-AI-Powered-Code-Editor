...
const TemplateSelectionModel = ({ isOpen, onClose, onSubmit }: TemplateSelectionModelProps) => {
  ...
  const [category, setCategory] = useState<"all" | "frontend" | "backend" | "fulstack">("all");
  ...
  const handleSelectTemplate = (templateId: string) => { setSelectedTemplate(templateId) };
            ...
            <>
              ...
              <div className="flex flex-col gap-6 py-4">
                ...
                <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                  <div className="flex items-center text-sm text-muted-foregrounded">
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button className="bg-[#E93F3F] hover:bg-[#d03636] text-white" onClick={handleContinue}> Continue <ChevronRight size={16} className="ml-1" />
                    </Button>
                  </div>
                </div>
              </div>
